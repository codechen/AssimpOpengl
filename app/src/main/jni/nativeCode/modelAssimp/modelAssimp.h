...
#include "../../../../../../../../../android_tools/ndk/android-ndk-r11b/platforms/android-23/arch-arm/usr/include/jni.h"
#include <sstream>
#include <iostream>
#include <stdio.h>
#include <string>
...
public:
    ...
    ~ModelAssimp();
    void    PerformGLInits();
    void    ResetModel(JNIEnv *env, jobject instance, jstring objFileName, jstring mtlFileName, jstring texFileName);
    void    Render();

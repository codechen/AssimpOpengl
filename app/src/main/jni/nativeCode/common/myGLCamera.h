...
public:
    ...
    void        Reset(float FOV,          // in degrees
                      float zPosition,    // camera's location on Z axis
                      float nearPlaneDistance, // as large as possible
                      float farPlaneDistance // as small as possible
                );

...
JNIEXPORT void JNICALL
Java_com_anandmuralidhar_assimpandroid_MyGLRenderer_ResetModelNative(JNIEnv *env,
                                                                     jobject instance,
                                                                     jstring objFileName,
                                                                     jstring mtlFileName,
                                                                     jstring texFileName) {
    ...
    gAssimpObject->ResetModel(env, instance, objFileName, mtlFileName, texFileName);
